...
## Summary
Backend engineer at Amazon Prime Video building distributed REST and gRPC services, CI/CD reliability tooling, and AI-driven developer testing infrastructure. MS CS 3.9 GPA, first-author EMNLP 2025.
...
- Delivered backend REST and gRPC services serving 100K+ queries/day under a 300ms SLA, parallelizing downstream calls to improve P99 latency 3x under peak load.
...
- Rolled out LLM regression-testing tooling with a retry methodology that solved flaky tests, now used team-wide to catch quality regressions before production.
- Developed an AI evaluation framework processing 50K+ conversations/day with LLM-as-judge and automated fact validation, increasing defect discovery 60%.
- Established unit and integration test frameworks raising service validation coverage to 90%, improving production deployment reliability.
...
- Shipped auto-scaling AWS (EC2, ELB, SQS, S3) Flask REST system handling 1,000 concurrent requests with 30-second elastic shutdown and cost-efficient scaling.
## Education
...
Backend: REST, gRPC, microservices, distributed systems, event-driven, caching, PostgreSQL, DynamoDB
Systems: Docker, Kubernetes, CI/CD (Jenkins), auto-rollback, health checks
