...
- Delivered hybrid retrieval with an XGBoost classifier routing queries to parallel OpenSearch and catalog retrievers with LLM reranking, improving relevance 5% and cutting latency 50%.
...
### Image Search Engine ()
- Optimized image search over 10K images using clustering and LSH vector indexing, reducing nearest-neighbor retrieval time from 1 hour to 30 seconds.
## Education
