...
## Summary
First-author EMNLP 2025 researcher and Machine Learning Engineer at Amazon Prime Video, building production retrieval, ranking, and recommendation systems for 1M+ users at consumer scale.
...
- Trained a LoRA fine-tuned query router for a hybrid retrieval system routing to parallel OpenSearch and catalog retrievers, improving relevance 5% and cutting latency 50%; adopted for production.
...
- Rolled out semantic query-to-title retrieval with multilingual E5 embeddings on a SageMaker endpoint and ANN search over a FAISS index, feature-flagged for zero live-turn degradation.
- Diagnosed model failures through an 11-experiment ablation study, fixing web-search poisoning of model reasoning and dropping the error rate from 75% to 0%.
...
- Prototyped a content-based recommender over 10K songs using 30 audio and metadata features with collaborative-filtering signals and cold-start handling for new tracks.
## Education
